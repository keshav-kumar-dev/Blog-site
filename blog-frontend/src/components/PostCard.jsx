...
const PostCard = ({ postData }) => {
  ...
  const mediaURL = postData?.mediaURL
    ? `${BASE_URL}/uploads/${postData.mediaURL}`
    : null;
      ...
      {postData && (
        <div className="w-full md:w-[40vw] my-4 p-4 md:px-10 border-2 rounded-2xl space-y-4 ">
          ...
          <img
            src={mediaURL}
            alt="Media"
            className="h-[50%] md:h-[60vh] w-full object-cover"
          />
          <div className="flex justify-between">
            <h5
              className="border-2 border-black md:w-[20%]  text-center my-2 p-1 rounded-xl"
            ...
            <h5
              className="border-2 border-black md:w-[40%]  text-center my-2 p-1 rounded-xl"
